...
namespace Ookii.Dialogs.Wpf
{
    ...
    public partial class TaskDialog : Component, IWin32Window
    {
        ...
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("The dialog's main instruction."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
        ...
        /// </value>
        [Localizable(true), Category("Appearance"), Description("The dialog's primary content."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
        ...
        /// </para>
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("Additional information to be displayed on the dialog."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
        ...
        /// </value>
        [Localizable(true), Category("Appearance"), Description("The text to be used in the footer area of the task dialog."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
