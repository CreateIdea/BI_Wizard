...
namespace Ookii.Dialogs.Wpf
{
    ...
    public class TaskDialogButton : TaskDialogItem
    {
        ...
        /// </para>
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("The text of the note associated with a command link button."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
