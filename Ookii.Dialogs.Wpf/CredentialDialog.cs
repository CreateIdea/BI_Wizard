...
namespace Ookii.Dialogs.Wpf
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        /// </para>
        /// </remarks>
        [Localizable(true), Category("Appearance"), Description("Additional text to display in the dialog."), DefaultValue(""), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
